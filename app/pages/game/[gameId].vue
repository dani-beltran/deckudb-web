<template>
  <div class="game-page">
    ...
    <!-- Error State -->
    <ErrorMessage class="error-with-top-margin" :message="error" @dismiss="clearError" />

    <!-- Not a game item State -->
    <div v-if="game && !isGameType && !loading && !error">
      <WarningMessage
        :message="`This is not a video game! You may be looking for ${game?.steam_app?.fullgame?.name || 'another item'} instead.`"
      />
...
useHead(() => ({ title: `${gameTitle.value} - Steam Deck Reports` }))
